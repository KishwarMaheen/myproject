...
class BoardTopicsTest(TestCase):
    ...
    def test_board_topics_view_error_status_code(self):
...
class NewTopicsTest(TestCase):
    ...
    def test_new_topic_view_error_status_code(self):
    ...
    def test_new_topic_url_contains_link_back_to_board_topics_view(self):
